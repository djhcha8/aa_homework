...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cake", "three", :chef)}.to raise_error(ArgumentError)
    end
  end

  describe "#add_ingredient" do
    before { cake.add_ingredient("sugar") }
  ...
  describe "#mix!" do
    ...
    before { ingredients.each { |ingredient| cake.add_ingredient(ingredient) } }
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cake.serve).to include("Master Chef")
    end
  end
